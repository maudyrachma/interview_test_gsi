...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Kategori Masalah</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title" style="padding-top: 9px;">Kategori Masalah</h3>
    ...
    <!-- End Modal Kategori Masalah-->

    <!-- Modal Edit Kategori Masalah-->
    ...
    <?php endforeach; ?>
    <!-- End Modal Edit Kategori Masalah-->
  </div>
